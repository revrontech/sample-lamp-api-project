...
return [
    ...
    'connections' => [
        ...
        'courier' => [
            'driver' => 'mysql',
            'host' => env('DB_COURIER_HOST', '127.0.0.1'),
            'port' => env('DB_COURIER_PORT', '3306'),
            'database' => env('DB_COURIER_DATABASE', 'gojek_courier'),
            'username' => env('DB_COURIER_USERNAME', 'root'),
            'password' => env('DB_COURIER_PASSWORD', 'root'),
            'strict' => false,
        ],
