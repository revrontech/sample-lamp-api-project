...
$router->group(['middleware' => 'auth:admin'], function ($app) {
    ...
    //Blogs
     ...
     $app->get('/blogs', 'V1\Common\Admin\Resource\BlogController@index');     
     $app->post('/blogs', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\BlogController@store']);     
     $app->get('/blogs/{id}', 'V1\Common\Admin\Resource\BlogController@show');
     $app->patch('/blogs/{id}', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\BlogController@update']);
     $app->delete('/blogs/{id}', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\BlogController@destroy']);
     $app->get('/blogs/{id}/updateStatus', 'V1\Common\Admin\Resource\BlogController@updateStatus');
    
    //News

    $app->get('/news', 'V1\Common\Admin\Resource\NewsController@index');
    $app->post('/news', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\NewsController@store']);
    $app->get('/news/{id}', 'V1\Common\Admin\Resource\NewsController@show');
    $app->patch('/news/{id}', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\NewsController@update']);
    $app->delete('/news/{id}', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\NewsController@destroy']);
    $app->get('/news/{id}/updateStatus', 'V1\Common\Admin\Resource\NewsController@updateStatus');
    ...
    //$app->get('/gettaxiprice/{id}', 'V1\Transport\Admin\VehicleController@gettaxiprice');
     ...
     //Translation
      $app->get('/translation', 'V1\Common\Admin\Resource\AdminController@translation');


     //CompanyState
     $app->get('/companystateservice', 'V1\Common\Admin\Resource\CompanyStateController@index');

     $app->post('/companystateservice', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\CompanyStateController@store']);

     $app->get('/companystateservice/{id}', 'V1\Common\Admin\Resource\CompanyStateController@show');

     $app->patch('/companystateservice/{id}', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\CompanyStateController@update']);

     $app->delete('/companystateservice/{id}', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\CompanyStateController@destroy']);
