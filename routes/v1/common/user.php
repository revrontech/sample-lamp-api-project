...
$router->post('/send-otp-firbase', 'V1\Common\CommonController@sendOtpFirebase');
...
$router->post('/countries1', 'V1\Common\User\HomeController@countries1');

$router->post('/socket', 'V1\Common\User\SocketController@checkDomain');
// $router->get('/stable', 'V1\Common\User\HomeController@stable');
$router->get('/cities-ignore-auth', 'V1\Common\User\HomeController@citiesIgnoreAuth');
$router->get('/promocode-ignore-auth', 'V1\Common\User\HomeController@promocodeIgnoreAuth');
$router->get('/menus-ignore-auth', 'V1\Common\User\HomeController@menusIgnoreAuth');
