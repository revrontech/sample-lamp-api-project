...
class PayrollTemplateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $resArr['all'] = PayrollTemplate::with('zone')->where('company_id',Auth::user()->company_id)->count();
        $resArr['active'] = PayrollTemplate::with('zone')->where('company_id',Auth::user()->company_id)->where('status', 'ACTIVE')->count();
        $resArr['inactive'] = PayrollTemplate::with('zone')->where('company_id',Auth::user()->company_id)->where('status', 'INACTIVE')->count();
