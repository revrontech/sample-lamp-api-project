...
class DisputeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $resArr['all'] = Dispute::where('company_id', Auth::user()->company_id)->count();
        $resArr['active'] = Dispute::where('company_id', Auth::user()->company_id)->where('status', 'active')->count();
        $resArr['inactive'] = Dispute::where('company_id', Auth::user()->company_id)->where('status', 'inactive')->count();
