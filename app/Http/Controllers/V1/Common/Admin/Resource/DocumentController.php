...
class DocumentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->has('page') && $request->page == 'all') {
         ...
         $resArr = [];
         $resArr['all'] = Document::where('company_id', Auth::user()->company_id)->count();
         $resArr['active'] = Document::where('company_id', Auth::user()->company_id)->where('status', '1')->count();
         $resArr['inactive'] = Document::where('company_id', Auth::user()->company_id)->where('status', '0')->count();
