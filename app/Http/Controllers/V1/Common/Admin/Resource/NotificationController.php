...
class NotificationController extends Controller
{
     ...
     public function index(Request $request)
    {
        ...
        $resArr['all'] = Notifications::where('company_id', Auth::user()->company_id)->count();
        $resArr['active'] = Notifications::where('company_id', Auth::user()->company_id)->where('status', 'active')->count();
        $resArr['inactive'] = Notifications::where('company_id', Auth::user()->company_id)->where('status', 'inactive')->count();
