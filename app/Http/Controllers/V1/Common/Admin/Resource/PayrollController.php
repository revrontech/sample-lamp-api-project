...
class PayrollController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $resArr['all'] = Payroll::where('company_id',Auth::user()->company_id)->count();
        $resArr['active'] = Payroll::where('company_id',Auth::user()->company_id)->where('status', 'COMPLETED')->count();
        $resArr['inactive'] = Payroll::where('company_id',Auth::user()->company_id)->where('status','<>','COMPLETED')->count();
