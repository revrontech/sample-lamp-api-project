...
class PromocodeController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      $datum = Promocode::where('company_id', Auth::user()->company_id);
        ...
        $resArr = [];
        $resArr['all'] = Promocode::where('company_id', Auth::user()->company_id)->count();
        $resArr['active'] = Promocode::where('company_id', Auth::user()->company_id)->where('status', 'ADDED')->count();
        $resArr['inactive'] = Promocode::where('company_id', Auth::user()->company_id)->where('status', 'EXPIRED')->count();
