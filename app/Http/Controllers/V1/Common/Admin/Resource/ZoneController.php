...
class ZoneController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $resArr = [];
        $resArr['all'] = Zone::with('city')->where('company_id',Auth::user()->company_id)->count();
        $resArr['active'] = Zone::with('city')->where('company_id',Auth::user()->company_id)->where('status', 'ACTIVE')->count();
        $resArr['inactive'] = Zone::with('city')->where('company_id',Auth::user()->company_id)->where('status', 'INACTIVE')->count();
    ...
    public function cityzones(){
     ...
     public function cityzonestypeShop(Request $request, $id){
        $city_zone = Zone::where("city_id",$id)->where('user_type',$request->type)->get();
        return Helper::getResponse(['data' => $city_zone]);
    }
