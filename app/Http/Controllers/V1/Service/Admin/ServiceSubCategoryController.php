...
class ServiceSubCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->has('page') && $request->page == 'all') {
         ...
         $resArr = [];
         $resArr['all'] = ServiceSubcategory::with('serviceCategory')->where('company_id', Auth::user()->company_id)->count();
         $resArr['active'] = ServiceSubcategory::with('serviceCategory')->where('company_id', Auth::user()->company_id)->where('service_subcategory_status', '1')->count();
         $resArr['inactive'] = ServiceSubcategory::with('serviceCategory')->where('company_id', Auth::user()->company_id)->where('service_subcategory_status', '0')->count();
