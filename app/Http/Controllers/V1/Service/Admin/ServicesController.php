...
class ServicesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->has('page') && $request->page == 'all') {
         ...
         $resArr = [];
         $resArr['all'] = Service::with('serviceCategory')->with('subCategories')->where('company_id', Auth::user()->company_id)->count();
         $resArr['active'] = Service::with('serviceCategory')->with('subCategories')->where('company_id', Auth::user()->company_id)->where('service_status', '1')->count();
         $resArr['inactive'] = Service::with('serviceCategory')->with('subCategories')->where('company_id', Auth::user()->company_id)->where('service_status', '0')->count();
