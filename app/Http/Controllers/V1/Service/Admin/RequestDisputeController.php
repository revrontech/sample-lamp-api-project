...
class RequestDisputeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $resArr['all'] = ServiceRequestDispute::where('company_id', Auth::user()->company_id)
                                    ->with('user','provider','request')->count();
        $resArr['active'] = ServiceRequestDispute::where('company_id', Auth::user()->company_id)
                                    ->with('user','provider','request')->where('status', 'open')->count();
        $resArr['inactive'] = ServiceRequestDispute::where('company_id', Auth::user()->company_id)
                                    ->with('user','provider','request')->where('status', 'closed')->count();
