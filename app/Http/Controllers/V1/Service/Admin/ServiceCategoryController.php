...
class ServiceCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->has('page') && $request->page == 'all') {
         ...
         $resArr = [];
         $resArr['all'] = ServiceCategory::where('company_id', Auth::user()->company_id)->count();
         $resArr['active'] = ServiceCategory::where('company_id', Auth::user()->company_id)->where('service_category_status', '1')->count();
         $resArr['inactive'] = ServiceCategory::where('company_id', Auth::user()->company_id)->where('service_category_status', '0')->count();
