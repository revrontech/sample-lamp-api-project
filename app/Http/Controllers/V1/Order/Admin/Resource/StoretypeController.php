...
class StoretypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->has('page') && $request->page == 'all') {
         ...
         $resArr = [];
         $resArr['all'] = StoreType::where('company_id', Auth::user()->company_id)->count();
         $resArr['active'] = StoreType::where('company_id', Auth::user()->company_id)->where('status', '1')->count();
         $resArr['inactive'] = StoreType::where('company_id', Auth::user()->company_id)->where('status', '0')->count();
    ...
    public function update(Request $request, $id)
    {
       ...
       public function storetypelistShop()
      {

        try {
             

            $storetypelist = StoreType::where('status',1)->get();
