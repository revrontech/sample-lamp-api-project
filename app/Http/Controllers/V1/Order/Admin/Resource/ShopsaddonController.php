...
class ShopsaddonController extends Controller
{
    ...
    public function index(Request $request,$id)
    {
        ...
        $resArr = [];
        $resArr['all'] = StoreAddon::where('company_id', $this->company_id)->where('store_id',$id)->count();
        $resArr['active'] = StoreAddon::where('company_id', $this->company_id)->where('store_id',$id)->where('addon_status', '1')->count();
        $resArr['inactive'] = StoreAddon::where('company_id', $this->company_id)->where('store_id',$id)->where('addon_status', '0')->count();
...
public function addonlistShop(Request $request){
  try {
