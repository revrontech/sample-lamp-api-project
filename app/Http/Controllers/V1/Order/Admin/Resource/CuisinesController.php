...
class CuisinesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $resArr['all'] = Cuisine::with('storetype')->where('company_id', Auth::user()->company_id)->count();
        $resArr['active'] = Cuisine::with('storetype')->where('company_id', Auth::user()->company_id)->where('status', '1')->count();
        $resArr['inactive'] = Cuisine::with('storetype')->where('company_id', Auth::user()->company_id)->where('status', '0')->count();
