...
class RideRequestDisputeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $resArr['all'] = RideRequestDispute::where('company_id', Auth::user()->company_id)->with('user','provider','request')->count();
        $resArr['active'] = RideRequestDispute::where('company_id', Auth::user()->company_id)->with('user','provider','request')->where('status', 'open')->count();
        $resArr['inactive'] = RideRequestDispute::where('company_id', Auth::user()->company_id)->with('user','provider','request')->where('status', 'closed')->count();
