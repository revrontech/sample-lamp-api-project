...
class LostItemController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $resArr['all'] = RideLostItem::where('company_id', Auth::user()->company_id)->with(['user','riderequests'])->count();
        $resArr['active'] = RideLostItem::where('company_id', Auth::user()->company_id)->with(['user','riderequests'])->where('status', 'open')->count();
        $resArr['inactive'] = RideLostItem::where('company_id', Auth::user()->company_id)->with(['user','riderequests'])->where('status', 'closed')->count();
